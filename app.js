...
function discountBadge(p){
  ...
  return percent?`<span class="discount-badge">خصم ${percent}%</span>`:'';
}
...
function footer(){
  ...
  <div>
    <a class="brand footer-brand" href="index.html"><img src="assets/athr-logo.png" alt="أثر"><span><b>أثر</b><small>معرفة تترك أثرًا</small></span></a>
    <p>منتجات رقمية عربية هادفة صُممت لتساعدك على بناء حياة أكثر وعيًا واتزانًا.</p>
  ...
  <div>
    ...
    <a href="shop.html?category=kids">الطفل والتربية</a>
    <a href="shop.html?category=growth">تطوير الذات</a>
    <a href="shop.html?category=money">الوعي المالي</a>
  </div>

  <div>
    <h4>المساعدة والسياسات</h4>
    <a href="contact.html">تواصل معنا</a>
    <a href="refund-policy.html">سياسة الاستبدال والاسترجاع</a>
    <a href="terms.html">الشروط والأحكام</a>
  </div>

  <div>
    <h4>أثر جديد في بريدك</h4>
    <p>منتجات وأفكار وموارد مختارة، بدون إزعاج.</p>
    <form class="newsletter" id="newsletter-form">
      <input type="email" name="email" required autocomplete="email" placeholder="البريد الإلكتروني" aria-label="البريد الإلكتروني">
